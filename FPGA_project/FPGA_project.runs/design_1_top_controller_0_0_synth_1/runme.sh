...
HD_PWD='C:/Users/jiho0/GitProjects/FPGA-Autonomous-Vehicle-Project/FPGA_project/FPGA_project.runs/design_1_top_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_top_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_top_controller_0_0.tcl
