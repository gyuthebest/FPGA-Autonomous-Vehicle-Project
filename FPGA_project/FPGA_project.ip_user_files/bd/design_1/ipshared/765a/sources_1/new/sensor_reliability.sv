...
module sensor_reliability #(
    ...
    consistency_check #(
        ...
        .WIDTH(28), .S(S_GYR), .CONSISTENCY_THRESHOLD(TH_GYR),
        .CONSISTENCY_U(U_CONS), .CONSISTENCY_D(D_CONS), .CONSISTENCY_N(N_CONS)
    ) u_cons_1_gyro_x (
        .clk(clk), .rst_n(rst_n), .valid_s1(valid_s1),
        .timeout_mask_2s  (tm2[CH_GX]),
        .consistency_mask (consistency_mask_2),
        .sensor_data      ({{12{sensor_data_in.gyro_x[15]}}, sensor_data_in.gyro_x}),
    ...
    consistency_check #(
        ...
        .consistency_mask (consistency_mask_2),
        .sensor_data      ({{12{sensor_data_in.gyro_y[15]}}, sensor_data_in.gyro_y}),
    ...
    consistency_check #(
        ...
        .consistency_mask (consistency_mask_2),
        .sensor_data      ({{12{sensor_data_in.gyro_z[15]}}, sensor_data_in.gyro_z}),
