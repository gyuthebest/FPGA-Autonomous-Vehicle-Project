...
module sensor_reliability #(
    ...
    output logic consistency_mask_approach_speed
);
    ...
    always_comb begin
        stuck_mask_1s[CH_DIST]  = range_err[CH_APSP] | jump_err[CH_APSP] | stuck_err[CH_APSP] | noise_err[CH_APSP]| cons_err[CH_APSP] | timeout_err[CH_APSP];
        stuck_mask_1s[CH_APSP]  = range_err[CH_DIST] | jump_err[CH_DIST] | stuck_err[CH_DIST] | noise_err[CH_DIST]| cons_err[CH_DIST] | timeout_err[CH_DIST];
        stuck_mask_1s[CH_AX]    = 1'b0;
        stuck_mask_1s[CH_AY]    = 1'b0;
        stuck_mask_1s[CH_AZ]    = 1'b0;
        stuck_mask_1s[CH_GX]    = 1'b0;
        stuck_mask_1s[CH_GY]    = 1'b0;
        stuck_mask_1s[CH_GZ]    = 1'b0;
    end
    ...
    consistency_check #(
        ...
        .consistency_mask (consistency_mask_고치기),
        .sensor_data      ({1'b0, sensor_data_in.distance}),
