...
module Reliability_Risk_Integration #(
    ...
    logic col_hazard, vision_A_headlight, vision_B_headlight;
    ...
    always_comb begin
        ...
        case (eff_tier_vision_B)
            ...
            2'b10: begin
                if (sim_data_in.accelerator > 4'd8) 
                    vision_B_accelerator = 4'd8;
                if ({1'b0, sim_data_in.speed_x} > spd_limit_60) 
                    vision_B_accelerator = 4'd0; 
    ...
    always_comb begin
        ...
        final_headlight = sim_data_in.headlight | vision_A_headlight | vision_B_headlight;
        final_hazard = sim_data_in.hazard | col_hazard;
