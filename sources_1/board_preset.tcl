proc getPresetInfo {} {
  return [dict create name {board_preset} description {board_preset}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.4 display_name {board_preset} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU__CRL_APB__USB0_BUS_REF_CTRL__DIVISOR0 {15}  \
    ...
    CONFIG.PSU__CRL_APB__USB0_BUS_REF_CTRL__ACT_FREQMHZ {99.999001}  \
    ...
    CONFIG.PSU__CRL_APB__USB0_BUS_REF_CTRL__FREQMHZ {100}  \
