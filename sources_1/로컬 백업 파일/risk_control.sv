...
//
    ...
    logic valid_out_risk, valid_out_rel;
    //logic signed [8:0] cur_delta_steer;
    ...
    always_comb begin
        ...
        case (eff_tier_posture_A)
            1'b1: begin
                //cur_delta_steer = sim_data_in.steering - sim_data_out.steering;
                posture_A_accelerator = 4'd0;

                if (sim_data_in.steering - sim_data_out.steering > 100)
                    posture_A_steering = sim_data_out.steering + 100;
                else if(sim_data_in.steering - sim_data_out.steering < -100) //
                    posture_A_steering = sim_data_out.steering - 100;
            end
        ...
        case (eff_tier_posture_B)
            2'b01: begin
                ...
                if (sim_data_in.steering - sim_data_out.steering > 140)
                    posture_B_steering = sim_data_out.steering + 140;
                else if(sim_data_in.steering - sim_data_out.steering < -140)
                    posture_B_steering = sim_data_out.steering - 140;
            end
        ...
        case (eff_tier_posture_C)
            2'b01: begin
                ...
                if (sim_data_in.steering - sim_data_out.steering > 160)
                    posture_C_steering = sim_data_out.steering + 160;
                else if(sim_data_in.steering - sim_data_out.steering < -160)
                    posture_C_steering = sim_data_out.steering - 160;
            end
            ...
            2'b10: begin
                ...
                if (sim_data_in.steering - sim_data_out.steering  > 120)
                    posture_C_steering = sim_data_out.steering + 120;
                else if(sim_data_in.steering - sim_data_out.steering  < -120)
                    posture_C_steering = sim_data_out.steering - 120;
            end
